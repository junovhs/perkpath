...
- **Leaflet vs Mapbox**: Leaflet chosen for being lightweight, free (no API keys required for tiles if using OSM/Carto), and easy DOM manipulation for custom markers.
